...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    welcome_message = (
        "👋 <b>Ласкаво просимо до сервісного центру Bambu Lab Україна!</b>\n\n"
        "Наш сервісний центр спеціалізується на діагностиці та ремонті обладнання Bambu Lab.\n"
        "Ми працюємо у будні дні з 9:00 до 18:00.\n\n"
        "📋 <b>Як ми вирішуємо проблеми:</b>\n"
        "1. Віддалена діагностика — консультація через телеграм або телефон\n"
        "2. Тестування — за потреби ми надамо тестову модель для друку\n"
        "3. Фізичний ремонт — якщо проблему неможливо вирішити віддалено, "
        "вам необхідно надіслати пристрій до нашого сервісного центру "
        "(доставка в обидва боки за рахунок клієнта)\n\n"
        ...
        "• Сервісний центр працює виключно з обладнанням Bambu Lab\n"
        "• Гарантійний ремонт можливий виключно для товарів, придбаних у нашому магазині\n"
        "• Гарантійний ремонт виконується виключно на території нашого сервісного центру\n\n"
